...
public class DemoController {
    ...
    public void demo04() throws JsonProcessingException {
        System.out.println("反序列化：");
        String json = "{\"fName\": \"John\", \"lName\": \"Green\", \"la\": \"La\", \"last\": \"Last\"}";
    ...
    public void demo07() throws JsonProcessingException {
        ...
        Demo07 demo07 = Demo07.builder().id(100L).name(name).build();
        String result = objectMapper.writeValueAsString(demo07);
        System.out.println(result);
    }

    @GetMapping("/demo08")
    public void demo08() throws JsonProcessingException {
        Demo08 demo08 = Demo08.builder().id(100L).date(new Date()).date2(new Date()).date3(new Date()).build();
        String result = objectMapper.writeValueAsString(demo08);
        System.out.println("序列化：");
        System.out.println(result);

        System.out.println("反序列化：");
        System.out.println(objectMapper.readValue(result,Demo08.class));
    }
}
